...
\begin{acronym}[H.264/SVC]
    %Fatori
	\acro{ACME}{Automatic Configuration Memory Error-injection}
    \acro{ALU}{Arithmetic Logic Unit}
    \acro{AHB}{AMBA High-performance Bus}
	...
	\acro{CSR}{Control Status Register}
    \acro{DCCM}{Data Closely-Coupled Memory}
    \acro{DMA}{Direct Memory Access}
	\acro{DMR}{Dual Modularity Redundancy}
	\acro{DSP}{Digital Signal Processor}
	\acro{DUT}{Device Under Test}
	\acro{EBD}{Essential Bits Data}
	\acro{ECC}{Error Correcting Code}
    \acro{EX}{Execute}
    \acro{Fatori-V}{FAult-TOlerant RISC-V}
    \acro{FC}{Fault Coverage}
    \acro{FF}{Flip-Flop}
    \acro{FI}{Fault Injection}
	\acro{FPGA}{Field Programmable Gate Array}
	\acro{FSM}{Finite-State Machine}
    \acro{FT}{Fault Tolerance}
	\acro{FTM}{Fault Tolerance Mechanism}
    \acro{GPIO}{General Purpose IO}
    \acro{HPM}{Hardware Performance Monitor}
    \acro{ICAP}{Internal Configuration Access Port}
    \acro{ICCM}{Instruction Closely-Coupled Memory}
	...
	\acro{LFA}{Linear Frame Address}
	\acro{LFAs}{Linear Frame Addresses}
    \acro{LSU}{Load-Store Unit}
    \acro{LUT}{Look-Up Table}
    \acro{M}{Memory Access}
    \acro{MMPP2}{Markov Modulated Poisson Process}
