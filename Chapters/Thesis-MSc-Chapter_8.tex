...
For standalone use, the user must provide a System Dictionary that describes the current architecture. In \ac{Fatori-V}, the System Dictionary is generated by the Pblock Model described in \Cref{chap7:pblock}. An example System Dictionary is provided in \Cref{app_c:system_dict}.
...
\hline
Board & Device & \(W_f\) & \(N_\text{dummy}\) & Physical limits and rows & Mapping constants \\
\hline
\hline
