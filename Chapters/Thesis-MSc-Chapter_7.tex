...
The Generation Stage translates the verified configuration into the interface macro files required by the build flow. These include SystemVerilog headers for feature selection, \ac{FTM} configuration, and pblock constraints, as well as firmware headers for benchmark selection and Vivado \texttt{.tcl} scripts for the build flow.
