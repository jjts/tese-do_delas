...
% !TEX root = ../main.tex
% #############################################################################
\fancychapter{Background and Baseline SoC Selection}
...
\ac{Fatori-V} required an existing open-source \ac{RISC-V} \ac{RTL} baseline that supported \ac{RTL} modification, \ac{FTM} integration, software execution, and \ac{FPGA} implementation. This section compares candidate state of the art \acp{SoC} against the requirements defined in \cref{chap1:requirements}.
...
\hline
\end{tabular}
\caption{Comparison of open-source \ac{RISC-V} candidates against the criteria from \cref{chap1:requirements}. Values marked with * come from specific published configurations.}
