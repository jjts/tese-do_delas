...
\title{Fault Tolerant RISC-V for Space Applications}
\subtitle{Fault Tolerance analysis and implementation}
%
% -----------------------------------------------------------------------------
% REQUIRED: Author
...
\supervisor{Prof. José Teixeira de Sousa}
\othersupervisor{Prof. Rui Policarpo Duarte}
%
% -----------------------------------------------------------------------------
...
\vogalone{Prof. Mário Pereira Véstias}
